...
صنف إشـارة [صنف_المالك: صنف، صنف_الحمولة: صنف] {
    عملية هذا.اربط(خانة: مغلفة (سند[صنف_المالك]، حمولة: سند[صنف_الحمولة]))؛
    عملية هذا.افصل(خانة: مغلفة (سند[صنف_المالك]، حمولة: سند[صنف_الحمولة]))؛
    عملية هذا.افصل(معرف: صـحيح_متكيف)؛
    عملية هذا.هات_عدد_الروابط(): صـحيح؛
    عملية هذا.أرسل(المالك: سند[صنف_المالك]، الحمولة: سند[صنف_الحمولة])؛
