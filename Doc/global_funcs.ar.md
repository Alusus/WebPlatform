...
دالة `ابن_وابدأ_الخادم` (`buildAndStartServer`). تُرجع مؤشرًا إلى بيانات جلسة الخادم، أو 0 في حال
فشل بدء الخادم. يجب أن يُمرر هذا المؤشر لاحقًا إلى دالة `أوقف_الخادم` (`stopServer`).
