...
صنف مـبدال {
    ...
    عرف بدل_إلى(فرع: سـندنا[ضـبيطة])؛
    عرف بدل_إلى(فرع: سـندنا[ضـبيطة]، اسم_الانتقال: نـص)؛
    عرف أيجب_الاحتفاظ_بالفرع(فرع: سند[ضـبيطة])؛
}
```
...
```
عرف أيجب_الاحتفاظ_بالفرع: مغلفة (الفرع: سند[ضـبيطة]): ثـنائي؛
```
...
```
عرف أضف(فرع: سـندنا[ضـبيطة])؛
عرف أضف(فرع: سـندنا[ضـبيطة]، اسم_الانتقال: نـص)؛
```
...
ما إذا كان النقر على الخلفية (الطبقة المُعتمة) يجب أن يغلق المزلق. القيمة الافتراضية `صـحيح`.
