...
* `مصفوفة_مصدر` (`sourceArray`): `مصفوفة [مصدر_فيديو]` (` Array[VideoSource]`). المصادر والانواع للفيديو.
* `مصفوفة_مسار` (`trackArray`): `مصفوفة [مسار_فيديو]` (` Array[VideoTrack]`). المسارات والترجمات للفيديو.
