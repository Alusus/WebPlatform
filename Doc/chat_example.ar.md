...
صنف خـيار_القائمة {
    ...
    عملية هذا~هيئ(رابط: نـص, عنوان: نـص, أيقونة: نـص) {
        // مساحة مستطيلة لتحوي الضبيطات الفرعية
        هذا.المشهد = صـندوق({}).{
            // نطبق بعض الأطرزة
            الطراز.{
            ...
            // نطبق طراز على ضبيطة فرعية من الفئة وسم
            الطراز(">>label").{
            ...
            // نقوم بتطبيق طراز على ضبيطة فرعية من الفئة وسم 
            ...
            أضف_فروع({
                // ضبيطة رابط
                // و الذي يحوي على ضبيطة فرعية هي نص
        ...
        هذا.المشهد = صـندوق({}).{
            ...
            أضف_فروع({
                ...
                مـدخل_نص().{
                    ...
                    عند_انتهاء_الكبسة.اربط(مغلفة (ضبيطة: سند[مـدخل_نص]، الحمولة: سند[نـص]) {
                        إذا الحمولة == "Shift+Enter" {
                            عرف بيانات_جديده: نـص = نـص("- ") + رمّز_النص_الفائق(ضبيطة.هات_النص()).شذب()؛
                            ضبيطة.حدد_النص(نـص())؛
                ...
                الـزر(نـص("أرسل")).{
                    ...
                    // كما يتم إعادة المدخل النصي إلى الحالة الفارغة لاستقبال دخل جديد
                    عند_الضغط.اربط(مغلفة (ضبيطة: سند[ضـبيطة]، الحمولة: سند[صحيح]) {
